...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        objImagen = (ImageView) findViewById(R.id.Image_btn);
        ...
        EditText descripcion = (EditText) findViewById(R.id.txtdescrip);
        ...
        btnSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(byteArray.length != 0) {
                    ...
                    Toast.makeText(getApplicationContext(), "No se obtuvo registro!", Toast.LENGTH_LONG).show();
                }
            }
        });

        Button btnFotos = (Button) findViewById(R.id.btngallery);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode == PETICION_ACCESO_CAM){
            ...
            Toast.makeText(getApplicationContext(), "Permitir Acceso", Toast.LENGTH_LONG).show();
        }
    }
